class Management::IndexView < ApplicationView
  ...
  def initialize(menu_items:, instruments:)
  ...
  def template(&block)
    ...
    div(class: "mx-auto w-full max-w-7xl grow flex xl:px-2") do
      ...
      div(class: "basis-42 border-b border-gray-200 px-4 py-6 sm:px-4 xl:w-36 xl:shrink-0 xl:border-b-0 xl:px-0 border-r") do 
        # h1 { "Left column area" }
      ...
      div(class: "flex w-full") do
        div(class: "px-4 py-6 sm:px-4 lg:pl-6 xl:flex-1 xl:pl-6") do
          ...
          render Instruments::IndexView.new(instruments: @instruments)
